...
public class Main {
	...
	public final static int HIGHESTE = 9598464; //First east tile
	public final static int HIGHESTN = 19725312; //First north tile
	
	public final static int LOWESTE = 9590784-1536; //Last east tile
	public final static int LOWESTN = 19732992+1536; //Last north tile
	
	public final static int TILESIZE = 256; //Width of a tile in pixel
	public final static int FOLDERSIZE = 1536; //Width of all tiles in a folder
